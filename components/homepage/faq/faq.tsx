...
const Faq = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white mt-24">
      <Card className="" title="FAQ">
        <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <Typography>
                Aplikace je vyvijená především pro trénery s cílem usnadnit jim rutinní prácí jako je plánování termínu, sledování tréninku nebo výběr plateb od
                klientů.
              </Typography>
              <Typography>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              <Typography>
                Nezáleží na sportu nebo na otázce, AI Trenér dokáže navrhnout to co je v danou situaci nejlepší. Čím více informací má AI Trenér, tím přesněji a
                lépe dokáže odpovědět.
              </Typography>
            </AccordionContent>
          </AccordionItem>
