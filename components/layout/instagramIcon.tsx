const InstagramIcon = ({ circle }: { circle?: boolean }) => {
  return (
    <a href="https://www.instagram.com/michaelakorinkova___/">
      <svg data-name="Layer 1" id="Layer_1" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" height={24} width={24}>
        <path
        ...
        />
        <path className="fill-teal-900" d="M90.14,32a5.73,5.73,0,1,0,5.73,5.73A5.73,5.73,0,0,0,90.14,32Z" />
        <path
          className="fill-teal-900"
