const YouTubeIcon = () => {
  return (
    <a href="https://www.youtube.com/@michaelakorinkovajumping3662">
      <svg data-name="Layer 1" id="Layer_1" height={24} width={24} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        />
        <polygon className="fill-teal-900" points="54.13 47.61 54.13 80.39 82.12 64 54.13 47.61" />
      </svg>
    </a>
  );
};
